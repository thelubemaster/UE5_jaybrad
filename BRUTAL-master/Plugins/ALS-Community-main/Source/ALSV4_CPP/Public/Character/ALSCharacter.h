...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "ALS|HeldObject")
		void AttachToMYSocket(USkeletalMeshComponent* MetaHumanBody,FName SocketName,UStaticMesh* NewStaticMesh, USkeletalMesh* NewSkeletalMesh,
			class UClass* NewAnimClass, FVector Offset);
