...
void AALSCharacter::AttachToMYSocket(USkeletalMeshComponent* MetaHumanBody,FName SocketName,UStaticMesh* NewStaticMesh, USkeletalMesh* NewSkeletalMesh, UClass* NewAnimClass, FVector Offset)
{
	ClearHeldObject();
	...
	HeldObjectRoot->AttachToComponent(MetaHumanBody,
		FAttachmentTransformRules::SnapToTargetNotIncludingScale, AttachBone);
	HeldObjectRoot->SetRelativeLocation(Offset);
}
