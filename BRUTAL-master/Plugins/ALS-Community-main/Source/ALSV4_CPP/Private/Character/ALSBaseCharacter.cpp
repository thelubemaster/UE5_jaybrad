...
FTransform AALSBaseCharacter::GetthirdPersonCameraTransform()
{
	FTransform ReturnObject;
	ReturnObject.SetLocation(GetActorLocation());
	//ReturnObject.SetRotation(GetActorRotation());
	//this->GetthirdPersonCameraTransform()
	return ReturnObject;
}
