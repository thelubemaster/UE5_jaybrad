                                       ...
                                       UDragDropOperation* InOperation)
{
	...
	AModdedALSCharacter* MyPawn = Cast<AModdedALSCharacter>(UGameplayStatics::GetPlayerPawn(GetWorld(), 0));
	...
	{
		MyPawn->DropItem(ItemDisplay->ItemData, DropWidget->OriginalOwner);
	}
