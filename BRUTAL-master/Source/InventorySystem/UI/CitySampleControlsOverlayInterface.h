...
class INVENTORYSYSTEM_API UCitySampleControlsOverlayInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 * @see UCitySampleControlsOverlay
 */
class INVENTORYSYSTEM_API ICitySampleControlsOverlayInterface : public IInterface
{
	GENERATED_BODY()
