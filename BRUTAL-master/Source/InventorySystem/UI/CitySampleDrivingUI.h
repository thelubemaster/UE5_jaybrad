...
struct INVENTORYSYSTEM_API FCitySampleDrivingStateDescription
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class INVENTORYSYSTEM_API UCitySampleDrivingUI : public UCitySamplePanel
{
	GENERATED_BODY()
